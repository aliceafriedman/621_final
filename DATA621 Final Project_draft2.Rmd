...
df_both %>% 
  ggplot( aes(factor(sex_F), final_grade, fill = romantic)) + 
  geom_boxplot() + 
  xlab("Sex") + 
  ylab("Final Grade") + 
...
```{r echo=FALSE}
df_both %>% 
  ggplot(aes(y=final_grade, x=factor(studytime), fill=studytime)) + 
  geom_boxplot() + 
  xlab("Study Time") + 
  ylab("Final Grade") + 
...
```{r echo=FALSE}
df_both %>% 
  ggplot(aes(y=final_grade, x=factor(internet), fill=internet)) + 
  geom_boxplot() + 
